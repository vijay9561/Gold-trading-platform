...
$html = '<span>'
        . '<br><span style="font-size:14px;text-align:left;color:gray;">Suvarnasiddhi Sell Trade Invoice'
        . '</span>'
        . '</span>';
// output the HTML content
//$pdf->writeHTML($html, true, false, true, false, '');

$html = '<span style="text-align:center;font-size:20px;text-transform:uppercase;">Suvarnasiddhi Sell Trade INVOICE'
...
$html = '<br><br><br><span style="text-align:center;font-size:18px;font-weight:bold;text-decoration:underline;">SELL GOLD Particulars</span><br><br><div style="">'
        . '<br><br>'
       ...
       . '<tr><th>Trade ID : </th><td>' .$loan->TRADE_ID. '</td></tr>'
        . '<tr><th>Trade Date : </th><td>' .date('d-m-Y', strtotime($loan->DATES)) . '</td></tr>'
         ...
         .'<tr><th>Market Limit Price:&nbsp;</th><td>INR ' .$loan->MARKET_RATE. '</td></tr>'
        .'<tr><th>Total Amount:&nbsp;</th><td>INR ' .$loan->TOTAL_INR. '</td></tr>'
